...
echo
echo "Checking for Debian-based pakcage managers &"
echo
...
then
	echo "Most likely your Linyx distribution is Red Hat-based."
else
	echo "Unable to determine Linux distribution based."
fi
